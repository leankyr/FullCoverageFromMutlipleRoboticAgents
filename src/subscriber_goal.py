...
class SubscriberNode:
    ...
    def __init__(self):
        ...
        # Struct that holds the map origin
        self.origin = {}
        self.origin['x'] = 0
        self.origin['y'] = 0
        self.origin['x_px'] = 0
        ...
        # Struct that holds the robot pose
        self.robotPose = {}
        self.robotPose['x'] = 0
        self.robotPose['y'] = 0
        self.robotPose['th'] = 0
    ...
    def ogmCallback(self, data):
        ...
        # Resize OGM and Coverage Map when the SLAM map expands
    ...
    def readRobotPose(self, event):
        ...
        self.robotPose['x_px'] = int(self.robotPose['x'] / self.resolution)
        self.robotPose['y_px'] = int(self.robotPose['y'] / self.resolution)
