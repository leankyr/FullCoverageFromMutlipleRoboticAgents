...
class SubscriberNode:
    ...
    def __init__(self):
        ...
        # Useful CostMap variables
        self.costmap = [] # list
        #self.coverage = []
        self.previousCostMapWidth = 0
        self.previousCostMapHeight = 0
        self.CostMapDataReady = False
        ...
        # dict that holds the costmap origin
        self.costorigin = {} # dict
        self.costorigin['x'] = 0
        self.costorigin['y'] = 0
        self.costorigin['x_px'] = 0
        self.costorigin['y_px'] = 0
        ...
        rospy.Subscriber('/move_base/global_costmap/costmap', OccupancyGrid, self.costmapCallback, queue_size=1, \
                            buff_size=2**24)
